...
const contactInfo = [
  { Icon: Mail, detail: "evanmarhian2@gmail.com", label: "Email" },
  { Icon: Phone, detail: "+62 857 7099 2965", label: "Phone" },
  { Icon: MapPin, detail: "Jakarta Selatan, Indonesia", label: "Location" },
];

function ContactInfoCard({ Icon, detail, label }) {
  return (
    <div className="flex items-start space-x-4">
      <div className="p-3 rounded-full bg-primary-green bg-opacity-10 text-primary-green flex-shrink-0">
        <Icon size={24} />
      </div>

      <div className="w-full min-w-0">
        <p className="text-sm font-medium text-grayish-blue">{label}</p>
        <p className="text-lg font-semibold text-dark-blue break-words">
          {detail}
        </p>
      </div>
    </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <input
                  ...
                  required
                  className="p-4 border border-border-gray rounded-lg focus:ring-primary-green focus:border-primary-green transition-colors text-dark-blue"
                />
                <input
                  type="email"
              ...
              <input
                ...
                placeholder="Subject"
                required
                className="w-full p-4 border border-border-gray rounded-lg focus:ring-primary-green focus:border-primary-green transition-colors text-dark-blue"
              />
